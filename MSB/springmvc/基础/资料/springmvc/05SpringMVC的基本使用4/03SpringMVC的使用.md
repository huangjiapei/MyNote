...
![image-20210905233809020](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20210905233809020.png)

![image-20210905233931549](C:\Users\lenovo\AppData\Roaming\Typora\typora-user-images\image-20210905233931549.png)

执行顺序：

（1）正常执行

preHandlre->controller方法->postHandler->页面跳转->afterHandler

（2）出现异常

无论哪个环节出异常，afterHandler肯定会执行
